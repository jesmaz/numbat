...
class ParseTreeList : public ParseTreeNode {
	...
	public:
		...
		ParseTreeList (uint32_t line, uint32_t pos) : ParseTreeNode (line, pos) {}
		ParseTreeList (const std::vector <PTNode> & args) : ParseTreeNode (args.front ()->getLine (), args.front ()->getPos ()), args (args) {}
