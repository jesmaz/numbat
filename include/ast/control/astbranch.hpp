...
class ASTbranch : public ASTbase {
	...
	public:
		...
		virtual const std::list <const ASTbase *> getErrors () const {auto c = cond->getErrors (), b = body->getErrors (), a = alt->getErrors (); c.splice (c.end (), b); c.splice (c.end (), a); return c;}
